...
func (t *S1Chaincode) Init(stub shim.ChaincodeStubInterface) pb.Response {
	...
	if len(args) != 2 {
		return shim.Error("Incorrect argument numbers. Expecting 2")
	}
...
func (t *S1Chaincode) query(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	// const INT_MAX = "testkez"
	// const INT_MIN = "testkex"
	// keysIter, err := stub.GetStateByRange(INT_MIN, INT_MAX)
	// 最后关闭迭代器接口
